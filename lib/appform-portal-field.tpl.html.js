...
ngModule.run(['$templateCache', function ($templateCache) {
  $templateCache.put('wfm-template/appform-portal-field.tpl.html',
    ...
    '        <appform-portal-field-number value="ctrl.model" field="ctrl.field"></appform-field-number>\n' +
    '      </div>\n' +
    '      <div ng-switch-when="location">\n' +
    '        <appform-portal-field-location value="ctrl.model" field="ctrl.field"></appform-field-location>\n' +
    '      </div>\n' +
    '      <div ng-switch-when="signature">\n' +
    '        <appform-portal-field-signature></appform-field-signature>\n' +
    '      </div>\n' +
    '      <div ng-switch-default>\n' +
    '        <input\n' +
    '          type="{{ctrl.inputType(ctrl.field.props.type)}}"\n' +
    '          class="form-control"\n' +
