...
ngModule.run(['$templateCache', function ($templateCache) {
  $templateCache.put('wfm-template/appform-portal.tpl.html',
    ...
    '          <appform-portal-field field="field" value="ctrl.model[field.props.fieldCode || field.props._id]"></appform-portal-field>\n' +
    '        </div>\n' +
    '        <button type="submit" class="btn btn-primary" ng-disabled="workorderForm.$invalid">Submit</button>\n' +
    '      </form>\n' +
    '    </div>\n' +
    '  </div>\n' +
    '</div>\n' +
